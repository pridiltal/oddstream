---
title: "Detecting anomalous series within a collection of sreaming time series"
...
output: 
    rmarkdown::html_vignette:
        toc: true
vignette: >
  %\VignetteIndexEntry{Detecting anomalous series within a collection of sreaming time series}
...
This R chunck will allow the user to get a three dimensional visualization of the data set
```{r 3dplot2, eval= FALSE, echo=TRUE, warning=FALSE, message=FALSE, out.width='100%', out.height='100%'}
library(oddstream)
